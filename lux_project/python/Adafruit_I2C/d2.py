...
lamp1 = 4 # GPIO pin using BCM numbering
lamp2 = 17
lamp3 = 18
lamp4 = 22
...
def setup():
     gpiopi.setFunction(lamp1, GPIO.OUT)
     gpiopi.setFunction(lamp2, GPIO.OUT)
     gpiopi.setFunction(lamp3, GPIO.OUT)
     gpiopi.setFunction(lamp4, GPIO.OUT)


# destroy function is called at WebIOPi shutdown
#def destroy():
#     GPIO.digitalWrite(lamp1, GPIO.LOW)
#     GPIO.digitalWrite(lamp2, GPIO.LOW)
#     GPIO.digitalWrite(lamp3, GPIO.LOW)
#     GPIO.digitalWrite(lamp4, GPIO.LOW)
...
while True:   
    ...
    if (spam>=500):
        ...
        GPIO.output(12,True)
        GPIO.output(15,True)
    elif(spam>=400 and spam<500):
        GPIO.output(7,False)
        GPIO.output(11,True)
        GPIO.output(12,True)
        GPIO.output(15,True)
    elif(spam>=300 and spam<400):
        GPIO.output(7,False)
        GPIO.output(11,False)
        GPIO.output(12,True)
        GPIO.output(15,True)
    elif(spam>=200 and spam<300):
        GPIO.output(7,False)
        GPIO.output(11,False)
